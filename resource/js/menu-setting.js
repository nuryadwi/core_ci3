...
$(document).ready(function() {
    ...
    // =========================================================
    var http = $(location).attr('href').split("/").splice(0, 1).join("/");
    ...
    $('.layout-type > a').on('click', function() {
        ...
        if (temp == "dark") {
            ...
            $('.layout-css').attr("href", base_url + "assets/css/layout-dark.css");
        } else {
    ...
    $('#theme-rtl').change(function() {
        ...
        if ($(this).is(":checked")) {
            $('.rtl-css').attr("href", base_url + "assets/css/layout-rtl.css");
        } else {
            $('.rtl-css').attr("href", "");
        }
    });
